...
### Reference: [Build and deploy](/docs/reference/deploy)
...
### Article: [Intro to IBM Bluemix DevOps Services, Part 4: Deploy to Bluemix automatically with the delivery pipeline](http://www.ibm.com/developerworks/cloud/library/cl-intro4-app/index.html)  <img src="../all/images/sout.gif"  align="bottom" style="display: inline; margin: 0px; border-style: none; margin-bottom: 5px;">
