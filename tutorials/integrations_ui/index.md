...
1. To fork the sample into DevOps Services, click In the [DevOps automated toolchain sample app](https://github.com/oneibmcloud/devops-tutorial-2), click <img class="inline" src="./images/deploy-button.png"  alt="Deploy to Bluemix"> to fork the sample into DevOps Services. 
